  ...
  tabPanel("Data Visualization",
           sidebarLayout(
             sidebarPanel(
               ...
               selectizeInput(inputId = "dropdown_data",label = "Select Data", choices = data_list, selected = NULL, multiple = FALSE, options = list(placeholder = "Type to search...", maxItems = 1)),
